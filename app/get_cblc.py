...
class CBLC:
    ...
    def init(self):
        with data as file:
            for line in range(0, total_lines):
                ...
                self.parse_registry(file.read(reg_size))

    def get(self):
        return self.cblc_dict
    ...
    def parse_header(self, line):
        ...
        self.cblc_dict['00'].append(dict(zip(keys, parsed)))
        # return dict(zip(keys, parsed))  # zip combines iterable elements

    def parse_registry_one_day(self, line):
        ...
        self.cblc_dict['01'].append(dict(zip(keys, parsed)))
        # return dict(zip(keys, parsed))

    def parse_registry_three_days(self, line):
        ...
        self.cblc_dict['02'].append(dict(zip(keys, parsed)))
        # return dict(zip(keys, parsed))

    def parse_registry_fiften_days(self, line):
        ...
        self.cblc_dict['03'].append(dict(zip(keys, parsed)))
        # return dict(zip(keys, parsed))

    def parse_registry_trailer(self, line):
        ...
        self.cblc_dict['99'].append(dict(zip(keys, parsed)))
        # return dict(zip(keys, parsed))
